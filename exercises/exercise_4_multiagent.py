...
def privacy_agent(state: State) -> dict:
    ...
    llm = get_llm()
    prompt = f"""Bạn là chuyên gia về quyền riêng tư và bảo vệ dữ liệu cá nhân. Phân tích câu hỏi:

Câu hỏi: {state['question']}
Phân tích pháp lý: {state.get('law_analysis', 'N/A')}

Tập trung: GDPR, CCPA, data protection, privacy rights, data breach, nghĩa vụ thông báo,
đồng ý xử lý dữ liệu, biện pháp khắc phục và rủi ro xử phạt."""
